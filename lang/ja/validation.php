...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'expense' => '諸費用',
        'rent' => '賃料',
        'fixed_expenditure' => '月固定支出（管理費等）',
        'loan' => '借入額',
        'loan_period' => '借入期間',
        'interest' => '金利',
        'repay' => 'ローン返済月額',
        'other_income_name' => 'その他固定収入の名前',
        'other_income_frequency' => 'その他固定収入の頻度',
        'other_income_amount' => 'その他固定収入の金額',
        'other_expenditure_name' => 'その他固定支出の名前',
        'other_expenditure_frequency' => 'その他固定支出の頻度',
        'other_expenditure_amount' => 'その他固定支出の金額',
        'title' => 'タイトル',
        'image' => '画像',
        'text' => '本文',
    ],
